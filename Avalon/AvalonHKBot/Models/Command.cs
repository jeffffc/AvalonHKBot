...
namespace AvalonHKBot.Models
{
    class Command
    {
        ...
        public Command(string Trigger, bool AdminOnly, bool GlobalAdminOnly, bool DevAdminOnly, bool GroupOnly, Bot.CommandMethod Method)
        {
            this.Trigger = Trigger;
            this.AdminOnly = AdminOnly;
            this.GlobalAdminOnly = GlobalAdminOnly;
